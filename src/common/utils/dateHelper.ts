...
export const startOfDay = (date: DateTime | Date | string): DateTime =>
	createDate(date).startOf("day");
export const endOfDay = (date: DateTime | Date | string): DateTime => createDate(date).endOf("day");
export const startOfMonth = (date: DateTime | Date | string): DateTime =>
	createDate(date).startOf("month");
export const endOfMonth = (date: DateTime | Date | string): DateTime =>
	createDate(date).endOf("month");
